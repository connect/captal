...
$(document).ready(function(){
    ...
    block.add = function(o) { debug('block.add('+JSON.stringify(o)+')');        
                ...
                '<div class="blk_wrapper">\
                    <div class="blk_header">\
                        <div class="field small logicGO" title="GOTO перейти к параграфу">\
                            <img id="logicGOicon" src="img/16/brick_go.png" onclick="gui.logicGO(this)">\
                            <div class="hint">Переход к</div>\
                            <input id="logicGO" type="text" onblur="gui.logicFieldUpdate(this)">\
                        </div>\
                        <div class="field logicTRUE" title="IF TRUE срабатывает при выполнении условия">\
                            ...
                            <input id="logicTRUE" type="text" onblur="gui.logicFieldUpdate(this)">\
                        </div>\
                        <div class="field logicFALSE" title="IF FALSE срабатывает при невыполнении условия">\
                            ...
                            <input id="logicFALSE" type="text" onblur="gui.logicFieldUpdate(this)">\
                        </div>\
                        <div class="field logicDO" title="DO вызвать скрипт">\
                            <img src="img/16/brick_error.png">\
                            <div class="hint">Выполнить</div>\
                            <input id="logicDO" type="text" onblur="gui.logicFieldUpdate(this)">\
                        </div>\
        ...
        editor.on('focus',function(e, ui){
            ...
            var blkID = $('#desk #blk_'+ o.tag +' .ace_editor').index( $('#'+id) );
 ...
 //console.log(blkID,blkTypeN)       
    ...
    block.translate = function(editorID, parID, blkID){ debug('block.translate('+editorID+', '+parID+', '+blkID+')');
        ...
        editorID = editorID || $('#desk .ui-tabs-panel[aria-hidden="false"] div.ace_focus').attr('id');
...
//debug(page.pageIndex,tpage);
    ...
    gui.logicFieldUpdate = function(e, doStore){ debug('gui.lolgicFieldUpdate(..)');
    ...
    gui.logicGO = function(e){ debug('gui.logicGO()');
        ...
        */
        ...
        paragraph.open( $(e).next().next().val(), paragraph.current() );    
    };
