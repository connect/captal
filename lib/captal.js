...
$(document).ready(function(){
    ...
    getMarks = function(text, callback){ debug('getMarks()');
            ...
            while( pos != -1) {
                ...
                if ( pos > 0 ) {
                    ...
                    if ( (prevCh < 48 || prevCh > 57 || isNaN(prevCh)) && (nextCh < 48 || nextCh > 57 || isNaN(nextCh) ) ) {
                        ...
                        ind = indexOfArray(tmark, marks);

                        // check if this is first accurance
                        if ( ind == -1 ) {
                            // new one, store it
                            marks.push([ prefix, affix ]);
                            freq.push([1, marks.length]);
                        } else {
        ...
        freq.sort(function(a,b){ return a[0] > b[0]; });
        ...
        for (t in freq){
            ...
            if (marks[ tfreq[1] ] != undefined) {
                
                marks[ tfreq[1] ].push( tfreq[0] );
            } else {
                
                console.log(t, tfreq)
            }
            smarks.push( marks[ tfreq[1] ] );
        }
        ...
        if (typeof callback === 'function') {
            ...
            callback(smarks, freq);

        } else {       

            for (var t in smarks){
                console.log('"'+smarks[t][0]+ 'XXX'+ smarks[t][1]+ '"',':',smarks[t][2]);
            }
