...
//debug(page.pageIndex,tpage);
    ...
    gui.maximize = function(){ debug('gui.maximized()');        
        
        if (cfg.maximized) {
            
            cfg.maximized = false;
            $('#desk').removeClass('maximized');
            $('#table-of-contents').removeClass('maximized');
            $('#navigator').removeClass('maximized'); 
            $('#btnMaximize img').attr('src', 'img/32/arrow_expand.png');
            
        } else {
            
            cfg.maximized = true;
            $('#desk').addClass('maximized');
            $('#table-of-contents').addClass('maximized');
            $('#navigator').addClass('maximized');
