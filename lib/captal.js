...
$(document).ready(function(){
    ...
    block.add = function(o) { 
        debug('block.add(',o.id,o.tag,o.lang,')');        
        ...
        if (o.tag == 'handler') {
            ...
            $('#desk #tab-'+ o.id +' #blk_'+o.tag).append(
                '<div class="blk_wrapper">\
                    <img class="lang-flag" src="img/16/flag_'+o.lang+'.png" lang="'+ o.lang +'">\n\
                    <div class="blk_header"></div>\
                    <div id="'+                 o.uid+'" \
                        captal-paragraph="'+    o.paragraph+'" \
                        captal-id="'+           o.id+'" \
    ...
    block.create = function(o){ 
        ...
        if (o.tag == 'handler') {
            // if handler
            //debug(paragraph.id);
            $('#data-source handlers').append('<'+o.tag+' name="'+paragraph.id+'" id="'+o.id+'"></'+o.tag+'>');
        } else {
            // if article
            $('#data-source article#'+ paragraph.id).append('<'+o.tag+' goto="'+o.logicGO+'" id="'+o.id+'" if="'+o.logicTRUE+'" ifnot="'+o.logicFALSE+'" do="'+o.logicDO+'" isglobal="'+o.logicGLOBAL+'">&lt;![CDATA['+o.body+']]&gt;</'+o.tag+'>');            
        }                      

        // add block
        var tblock = block.add({
            parahraph   : paragraph.id,
            id          : o.id,
            tag         : o.tag,
            body        : o.body,
            logicGO     : o.logicGO,
        ...
        tree.create_node( 'nav-'+ o.tag , { type: o.tag, id: 'nav_'+o.id, text: o.id });
    ...
    block.show = function(ID) { debug('block.show('+ID+')');
        var uid    = $('#tab-'+ paragraph.id +' .blk_editor[captal-id="'+ID+'"]').attr('id');
