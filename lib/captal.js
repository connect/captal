...
$(document).ready(function(){
	...
	readonly	: 0,
        ...
        requestURL          : null,
        remote_gameURL      : 'http://quest-book.ru/online2/getgame/',        
        remote_gamelistURL  : 'http://quest-book.ru/online2/gamelist',
        remote_statusesURL  : 'http://quest-book.ru/online2/statuses.json',
        local_gameURL       : '../dev/ajax.php?cmd=getgame&param=',
        local_gamelistURL   : '../dev/ajax.php?cmd=gamelist&',
        local_statusesURL   : '../dev/ajax.php?cmd=statuses.json',        
    };    
...
//debug(f.type); return;
    ...
    repo.game.get = function( gameID ){
        ...
        repo.gameURL = (cfg.debug) ? cfg.local_gameURL + gameID : cfg.remote_gameURL + gameID;
        ...
        $.ajax({            
            ...
            if (res.result == 'ok') {              
                ...
                // set read only mode if not author
    ...
    repo.game.list = function( callback ){
        ...
        repo.gamelistURL = (cfg.debug) ? cfg.local_gamelistURL : cfg.remote_gamelistURL;

        $.ajax({
            url: repo.gamelistURL,
            dataType: 'json'
        }).done(function( res ){
    ...
    repo.statusesURL = (cfg.debug) ? cfg.local_statusesURL : cfg.remote_statusesURL;
    $.ajax({
        url: repo.statusesURL,
        dataType: 'json'
    }).done(function(res){
