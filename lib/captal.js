...
$(document).ready(function(){
    ...
    project.addComponent = function(e){
        var tree =  $('#toc').jstree(true);
        
        // update data-source
        $('<component/>')
            .attr({
                id      : e.item.index_name, 
    ...
    project.listComponents = function(){
        ...
        $('#dlgRepoComp').dialog({
            ...
            open        : function(){
                ...
                repo.component.list(function(res){
                    ...
                    if (res.result == 'ok') {
                        ...
                        for (var i in res.data.list) {
                            ...
                            o = res.data.list[i];
                            repo.component.data[ o.game_id ] = o;

                            $('#dlgRepoComp #list').append( '<div id="'+ o.game_id +'" class="component" onclick=repo.component.select("'+o.game_id+'")>'+ o.fullname +'</div>');
                        }               
                    } else {
                        // error
                        error('Облако не доступно!');
                    }                   
                });
            },
            close: function() {
...
//debug(page.pageIndex,tpage);
    ...
    repo.component.add = function( o, callback ){
    ...
    repo.component.select = function( comID ){
        ...
        console.log( repo.component.data[ comID ].shortdesc )
        
        $('#dlgRepoComp #info').html(

            repo.component.data[ comID ].shortdesc
        );
    };
