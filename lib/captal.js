...
$(document).ready(function(){
    ...
    lang.eng = {
        ...
        project_export_actions      : 'Export actions',
    ...
    block.add = function(o) { debug('block.add(...)');        
        ...
        var tmpl    = $('#block-wrapper-template .blk_wrapper')
                        .clone()
                        .html()
        ...
        $(editor.textInput.getElement()).on('keydown',function(e, ui){
            ...
            if (e.key == '@' ){
                ...
                if (body.lastIndexOf('@@') == body.length-2) {
                    
                    var newID = paragraph.newID();

                    body = body.substr(0, body.length-2) +'@'+ newID;
                    editor.setValue(body.toString(), 1);
                    editor.resize(true);
                    ...
                    */                    
                    ...
                    paragraph.open({  paragraphID: newID, currentParagraphID: paragraph.current() });
