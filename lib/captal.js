        ...
        $('#desk #tab-'+ o.paragraph +' #blk_'+ o.tag ).append(
                '<div class="blk_wrapper">\
                    <div class="blk_header">\
                        <div class="field logicTRUE" title="IF TRUE срабатывает при выполнении условия"><img id="logicTRUEicon" src="img/16/brick.png" class="pointer"><input id="logicTRUE" type="text"></div>\
                        <div class="field logicFALSE" title="IF FALSE срабатывает при невыполнении условия"><img src="img/16/brick_delete.png"><input id="logicFALSE" type="text"></div>\
                        <div class="field logicDO" title="DO вызвать скрипт"><img src="img/16/brick_error.png"><input id="logicDO" type="text"></div>\
                        <div class="field logicGO" title="GOTO перейти к параграфу"><img id="logicGOicon" src="img/16/brick_go.png" class="pointer"><input id="logicGO" type="text"></div>\
