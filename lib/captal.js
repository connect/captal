...
$(document).ready(function(){
 ...
 //console.log(blkID,blkTypeN)       
        ...
        tree.create_node( 'nav-'+ o.tag , { type: o.tag, id: 'nav_'+ o.paragraph +'_'+ o.tag +'_'+ blkTypeN, text: (blkTypeN+1) });
    ...
    paragraph.show = function(parID) { debug('paragraph.show('+parID+')');
        ...
        $('#tab-'+ parID +' .blk_editor').each(function(index){           
            ...
            if (tag == 'script') counts[tag] = $(this).attr('captal-type');

            // push block to navigator
            tree.create_node( 'nav-'+ tag , { type: tag, id: 'nav_'+ parID +'_'+ tag +'_'+ (counts[tag]-1) , text: counts[tag] });
