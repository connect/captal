 ...
 //console.log(blkID,blkTypeN)       
    ...
    block.store = function(editorID){ debug('block.store('+ editorID +')');
        ...
        if (logicGObak != '') {  
            ...
            if ($('#data-source action[goto="'+logicGObak+'"]').length == 0) {
                ...
                // normal
                tree.set_icon(logicGObak, "img/16/page-ready.png" );
            }                               
        }        
        ...
        if (logicGO != '') {            
            if ($('#data-source article#'+logicGO+' action[goto]').length > 0) {
                // normal
                tree.set_icon(logicGO, "img/16/page-ready.png" );
            } else {                
                // deadend
        ...
        if ($('#data-source action[goto="'+parID+'"]').length == 0) {
            //orphan
            tree.set_icon(parID, "img/16/icon-page-red.png" );
        } else if ( $('#data-source action#'+parID+' action[goto]') == 0 ) {
            // deadend
            tree.set_icon(parID, "img/16/icon-page-yellow.png" );
        } else {
            // normal
            tree.set_icon(parID, "img/16/page-ready.png" );
        }                
    ...
    <metadata>\n\
                ...
                if ($('#data-source action[goto="'+node.id+'"]').length == 0) {
                    ...
                    // normal
                    tree.set_icon(node.id, "img/16/page-ready.png" );
                }
    ...
    paragraph.open = function(parID, curParID, callback){ debug('paragraph.open('+ parID +','+ curParID +')');
        ...
        if ( $('#data-source article#'+parID).length == 0 && $('#data-source handler[name="'+parID+'"]').length == 0 ) {
            ...
            if (max > 0) {
                // acricle tab
                $('#desk #tabs').append('<li><a href="#tab-'+ parID +'"><img class="tab-icon" src="img/16/page-ready.png"> '+ parID +' <img onclick="paragraph.close(this)" src="img/16/close.png"></a></li>');
            } else {
                // handler tab
    ...
    paragraph.show = function(parID) { debug('paragraph.show('+parID+')');
        ...
        $('#nav').jstree({
            ...
            types: {
                root     : { icon : "img/16/page-ready.png" },
                ...
                if (data.node.id == 'toc-book') {
                    ...
                    if ( $('#data-source article#'+data.text).length == 0 ) {
                        ...
                        if ($('#'+tabOld).length > 0) {
                            ...
                            $('a[href="#'+tabOld+'"')
                                .html( '<img src="img/16/page-ready.png"> \n\
                                        '+data.text+' \n\
