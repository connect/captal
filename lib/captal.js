 ...
 //console.log(blkID,blkTypeN)       
    ...
    paragraph.open = function(parID, curParID, callback){ debug('paragraph.open('+ parID +','+ curParID +')');
        ...
        if ( $('#data-source article#'+parID).length == 0 && $('#data-source handler[name="'+parID+'"]').length == 0 ) {
            ...
            if (max > 0) {
                // acricle tab
                $('#desk #tabs').append('<li><a href="#tab-'+ parID +'"><img class="tab-icon" src="img/16/page-new.png"> '+ parID +' <img onclick="paragraph.close(this)" src="img/16/close.png"></a></li>');
            } else {
                // handler tab
    ...
    paragraph.state = function(parID, state){
