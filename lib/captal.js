...
$(document).ready(function(){
    ...
    cleanName = function(str){
        ...
        if (str.match(/[^а-яa-z]+/ig) != null) {
            
            error('Допустимые символы имени: латиница, кириллица, тире и подчеркивание');
        }
        ...
        $('#dlgFlow').dialog({
            ...
            create      : function(){
                ...
                $('#data-source article').each(function(index){
                    ...
                    var id    = $(this).attr('id');
                    var label = $(this).attr('label') || false;
                    
                    nodes[id] = graph.addNode( (label) ? label : id );
                    ...
                    if (index == last){
                        ...
                        for (var i in links) {
                            ...
                            graph.addEdge( nodes[links[i][0]], nodes[links[i][1]]);
                        }
                    }
                });
