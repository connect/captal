...
$(document).ready(function(){
        ...
        $('#desk #tab-'+ o.paragraph +' #blk_'+ o.tag ).append(
                '<div class="blk_wrapper">\
                    <div class="blk_header">\
                        <div class="field logicTRUE" title="IF TRUE срабатывает при выполнении условия"><div class="pointer" onclick="gui.toggleControls(this)">Если:</div><input id="logicTRUE" type="text"></div>\
                        <div class="field logicFALSE" title="IF FALSE срабатывает при невыполнении условия"><div onclick="gui.toggleControls(this)">Если НЕ:</div><input id="logicFALSE" type="text"></div>\
                        <div class="field logicDO" title="DO вызвать скрипт"><div onclick="gui.toggleControls(this)">Выполнить:</div><input id="logicDO" type="text"></div>\
                        <div class="field small logicGO" title="GOTO перейти к параграфу"><div class="pointer" onclick="gui.toggleControls(this)">Переход:</div><input id="logicGO" type="text"></div>\
    ...
    block.create = function(o){ debug('block.create('+o.tag+')');
        ...
        tree.create_node( 'nav-'+ o.tag , { type: o.tag, id: 'nav_'+ o.paragraph +'_'+ blkID, text: blkID+1 });
