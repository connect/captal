...
$(document).ready(function(){
    ...
    block.add = function(o) { 
        ...
        if (o.tag == 'handler') {
            ...
            $('#desk #tab-'+ o.id +' #blk_'+o.tag).append(
                '<div class="blk_wrapper"><img class="lang-flag" src="img/16/flag_'+o.lang+'.png"><div class="blk_header" onclick="block.headerClick(this)"></span>'+o.name+':</div>\
                <div id="'+                 o.uid+'" \
                    captal-paragraph="'+    o.paragraph+'" \
                    captal-name="'+         o.name+'" \
                    captal-tag="'+          o.tag+'" \
    ...
    block.translated = function(res){
        ...
        $('#'+block.id)
            ...
            .after('<div class="autotrans"><b>Автоматический перевод:</b><div>'+ res.text[0] +'</div></div>\
                <div class="origtrans"><b>Оригинал:</b><div>'+editor.getValue()+'</div></div>');
