...
//$('#data-source').html(res);return;
    ...
    project.preloadPDF = function(pdf){ debug('project.preloadPDF()');
        ...
        $('#dlgImportPDF #sParSize option').remove();
        $('#dlgImportPDF #sParFont option').remove();
                    ...
                    for (var i in tpage.items){
                        ...
                        if ( line.str.match(/\d+/) != null )  {
                            ...
                            if (sizes.indexOf(line.height) < 0) {
                                ...
                                $('#dlgImportPDF #sParSize').append('<option value="'+line.height+'"> '+line.height+': '+line.str.substring(0,30)+'</option>');
                            }
                            // collect font names
                            if (fonts.indexOf(line.fontName) < 0) {
                                fonts.push(line.fontName);
                                $('#dlgImportPDF #sParFont').append('<option value="'+line.fontName+'"> '+line.fontName+': '+line.str.substring(0,30)+'</option>');
                            }
                        }                                                                  
                    }                                                                        
