...
$(document).ready(function(){
 ...
 //console.log(blkID,blkTypeN)       
    ...
    paragraph.copy = function(obj){ 
        ...
        // free previously copied paragraph
        $('#data-source article[copied]').removeAttr('copied');
        // mark target paragraph as copied
        $('#data-source article#'+parID).attr('copied',true);
    };
    ...
    paragraph.paste = function(){
        ...
        var sourcePar = $('#data-source article[copied]');        
        var folder    = $('#data-source folder:has([copied])');
    ...
    project.exportDOCX = function(){ debug('project.exportDOCX()');
        ...
        $('#data-source article').sort(alphanum).each(function(){
