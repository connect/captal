                ...
                if ( j > 0 ) {
                    ...
                    if (tact != '' && tact != null && actHTML.indexOf('goto="'+tact+'"') == -1) {
                        ...
                        if (cActRemove) {
                            ...
                            txtHTML = txtHTML.replace( amark.prefix + tact + amark.affix, '#'+amark.prefix + tact + amark.affix );
                        }
    ...
    block.parseActions = function(){
        ...
        for (var i in acts){
            ...
            var tact    = acts[i].substr(1),
                actObj  = $('#data-source article#'+parID+' action[goto="'+tact+'"]'),
            ...
            if (actObj.length == 0) {
                ...
                block.create({
                        ...
                        var obj = $('#tab-'+parID+' #blk_action:has("#'+actEditorID+'") #logicGO')[0];
            console.log('--',obj)
                ...
                if ( actObj.html() != actText ) {
                    
                    actObj.html( actText );
                    
                    // find action editor
                    var actEditorID = $('#tab-'+parID+' #blk_action [captal-goto="'+tact+'"]').attr('id'),
                        actEditor   = ace.edit(actEditorID);
        ...
        $('#data-source article#'+parID+' action').each(function(index){
            ...
            if ( $(this).attr('intext') > 0 ) {
                ...
                if (body.match( new RegExp('\#'+ targetID +'\\b','g' )) == null ) {
                    
                    //console.log('can`t find inline marker for',targetID)
