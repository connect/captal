...
$(document).ready(function(){
    ...
    lang.eng = {
        ...
        block                       : 'Block',
        block_copy                  : 'Copy current block',
        block_down                  : 'Lower block',
        block_indent                : 'Indent',
        block_outdent               : 'Outdent',
        block_raise                 : 'Raise block',
        block_specialchar           : 'Show hidden symbols',
        ...
        folder_icon_change          : 'Change folder icon',
        ...
        paragraph_is_end        	: 'This is ending',
    ...
    block.add = function(o) { debug('block.add(...)');        
        ...
        // 
        $(editor.textInput.getElement()).on('keydown',function(e, ui){
        ...
        if (o.tag == 'text') {
            ...
            if (o.translated === 'true') {
                ...
                $('#'+o.uid)
                    ...
                    .after('<div class="autotrans"><b>{L_TRANSLATION_AUTO}: <img src="img/16/flag_'+tranLang+'.png"></b><div>'+ tranText +'</div>Переведено сервисом<br><a href="http://translate.yandex.ru/" target="_blank">«Яндекс.Переводчик»</a></div>\
                        <div class="origtrans"><b>{L_ORIGINAL}: <img src="img/16/flag_'+origLang+'.png"></b><div>'+ origText +'</div></div>');
    ...
    block.delete = function(e){ debug('block.delete()');
        ...
        if (confirm(lang.current.block_delete +' '+node.text+'?')){   
        ...
        $.ajax({
                ...
                success: function(res){
                    ...
                    obj
                        ...
                        .attr('captal-translated', true)
                        .after('<div class="autotrans"><b>{L_TRANSLATION_MACHINE}: <img src="img/16/flag_'+tranLang+'.png"></b><div>'+ tranText +'</div>Переведено сервисом<br><a href="http://translate.yandex.ru/" target="_blank">«Яндекс.Переводчик»</a></div>\
                            <div class="origtrans"><b>{L_ORIGINAL}: <img src="img/16/flag_'+origLang+'.png"></b><div>'+ origText +'</div></div>');
    ...
    paragraph.delete = function(parID){ debug('paragraph.delete('+parID+')');
        ...
        if ($('#data-source article#'+parID).length > 0) {
            ...
            if (confirm( lang.current.paragraph_delete_confirm.replace('{ID}', parID) )) {
        ...
        if ($('#data-source').html().length > 0) {                                
            ...
            $('#dlgDebug').dialog({
                ...
                create: function(){
                    ...
                    debug(lang.current.atril_start);
    ...
    gui.search = function(){
        ...
        $('#dlgSearch').dialog({
            ...
            buttons: [{
                ...
                text: lang.current.search_replace,
                icons: {
            ...
            items: {
                mnuProject : {
                    ...
                    submenu: {
                        ...
                        _2: 'separator',                    
                        mnuProjectRepo: {
                            label	: lang.currnet.cloud_games,
                ...
                mnuBlock: {
                    ...
                    submenu: {                                             
                        ...
                        mnuBlockTranslate:{
                            label   : lang.current.machine_translation,
