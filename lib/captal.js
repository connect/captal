                    ...
                    click: function(){     
                            ...
                            $('<div/>')
                                ...
                                .html('<div>\
                                        ...
                                        <div class="par-content" onclick=block.show("'+parID+'","'+tag+'",'+blkID+')>'+ $(this)
                                                                        ...
                                                                        .replace(']]>','')
                                                                        .replace(']]&gt;','')
                                                                        .replace( new RegExp( iSearchVal, 'g'), '<span class="hightlight">'+iSearchVal+'</span>' ) +'</div>')
                        ...
                        if (cSearchTxt) {
                            ...
                            if (cSearchReg) {
                                ...
                                $('#data-source text:contains("'+ iSearchVal +'")').each(process);

                            } else {

                                $('#data-source text:Contains("'+ iSearchVal.toUpperCase() +'")').each(process);                                                        
                            }
                        }
