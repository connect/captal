    ...
    gui.tagList = function(tagID){
        ...
        $('#dlgTaglist').dialog({
            ...
            create      : function(){
                ...
                //var last  = $('#data-source article').has( 'metadata tag:contains('+tagID+')').length -1;
                
                function process2(index){
                ...
                function process(index){
                    ...
                    $('#dlgTaglist #search-results').append('<div captal-paragraph="'+parID+'" class="tagged" onclick="gui.tagJump(this)">'+parID+label+'</div>');
                };
                
                $('#dlgTaglist #tagName').html(tagID);
