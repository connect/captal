...
$(document).ready(function(){
    ...
    processActionsOLD = function(text, actMarkers, cActString, cActRemove, customMark){                
    ...
    block.parseActions = function(){
        ...
        if ( sorted.last().attr('intext') != unsorted.last().attr('intext') ) {    
            ...
            $(sorted).each(function(index){
                ...
                // update navigator
                //nav.set_text(nodeID, '§'+ $(this).attr('goto'));
                //nav.move_node(node, node.parent, index);
                //nav.set_id(nodeID, newID);
