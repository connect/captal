...
$(document).ready(function(){
    ...
    block.spellcheck = function(editorID, parID, blkID){
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                for (var i in res){
                    ...
                    //if (row.s)
                    //input = input.replace(row.word, row.s);
                    editor.session.addMarker(new Range(row.row, row.col, row.len),"ace_active-line",'inFront');
                } 
            }
        });
    };
