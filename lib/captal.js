...
//debug(f.type); return;
    ...
    repo.game.get = function( gameID ){
        //$.get('http://quest-book.ru/online2/')
        
        $.get('lib/repo_game_1.json',function(res){
    ...
    repo.game.list = function( callback ){
        repo.gamelistURL = (cfg.debug) ? 'lib/repo_gamelist.json' : 'http://quest-book.ru/online2/gamelist';
    ...
    repo.statusesURL = (cfg.debug) ? 'lib/repo_statuses.json' : 'http://quest-book.ru/online2/statuses.json';
    ...
    if (cfg.startup) { repo.game.get( cfg.startup ); }
