...
$(document).ready(function(){
    ...
    block.parseActions = function(){
        ...
        $('#data-source article#'+parID+' action').each(function(index){
            ...
            if ( acts[ $(this).attr('intext') ] != '#'+targetID){
        ...
        for (var i in acts){
            ...
            var tact    = acts[i].substr(1),
                actDOM  = $('#data-source article#'+parID+' action[goto="'+tact+'"]'),
        ...
        var unsorted = $('#data-source article#'+parID+' action[intext]'),
            sorted   = unsorted.clone().sort(function(a,b){ return $(a).attr('intext') - $(b).attr('intext'); });
        ...
        if( sorted.last().attr('intext') != unsorted.last().attr('intext') ) {
            ...
            $(sorted).insertBefore('#data-source article#'+parID+' metadata');
