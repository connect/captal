 ...
 //console.log(blkID,blkTypeN)       
    ...
    block.store = function(editorID){ debug('block.store('+ editorID +')');
        ...
        if ($('#data-source action[goto="'+parID+'"]').length == 0) {
            ...
            // normal
            tree.set_icon(parID, "img/16/icon-page.png" );
        }                
        ...
        if ($('#dlgSearch').dialog('isOpen')) {
            ...
            if (current.length == 0) {
                ...
                if (typeof startIndex == 'number') {
                    ...
                    $('#dlgSearch #search-results .highlight:eq('+startIndex+')').addClass('selected');
                    
                } else {
                
                    $('#dlgSearch #search-results .highlight:first').addClass('selected');
                }
        ...
        $('#dlgSearch').dialog({
            ...
            buttons: [{
                ...
                click: function(){  
                    ...
                    //debug('replace',parID,tag,blkID, pos);
                    ...
                    while (pos != -1) {                                                
                        ...
                        if (i == index) {
                            ...
                            if ($('#tab-'+parID).length > 0){
                                ...
                                editor.setValue( blk.replace( /\<\!\[CDATA\[/i,'')
                                                    .replace( /&lt;\!\[CDATA\[/i,'')
                                                    .replace(']]>','')
                                                    .replace(']]&gt;','') );
                            }
                ...
                click: function(){
                    ...
                    $('#dlgSearch #search-results .highlight').each(function(index){
                        ...
                        var row         = $('#dlgSearch .result-row').has( $(this) );
                        var parID       = row.attr('paragraph');
                        var tag         = row.attr('tag');
                        var blkID       = row.attr('block');                        
                        var blk         = $('#data-source article#'+parID+' '+tag+':eq('+blkID+')').html();                       
