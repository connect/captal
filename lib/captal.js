            ...
            $(this).children().each(function(){
                ...
                */
                ...
                if (tag == 'text' && ( tLang == sLang || sLang == 'all') ) {
                    ...
                    body = body +'<a href="#'+logicGO+'">'+ link +'</a>';
...
//$('#data-source').html(res);return;
    ...
    project.preloadDOCX1 = function(doc){ debug('project.preloadDOCX()');
        var i = 0;
    ...
    project.preloadDOCX2 = function(doc){ debug('project.preloadDOCX()');
        //res = res.replace(/–/g,'-');        
    ...
    project.preloadDOCX3 = function(doc){ debug('project.preloadDOCX()');        
        var i = 0;
        var last = $(doc).find('p').length;
        var classes = [];
        var centered = false;
    ...
    project.preloadPDFold = function(pdf){ debug('project.preloadPDF()');
