...
$(document).ready(function(){
    ...
    block.add = function(o) { debug('block.add('+JSON.stringify(o)+')');        
        ...
        editor.on('blur',function(e){ 
            ...
            var editorID = $(e.target.offsetParent).attr('id');
                ...
                */
                ...
                if ($('#data-source options').length == 0){
                    ...
                    $('#data-source book').append('<options>\
                        <linebreak>'+     cfg.lineBreak +'</linebreak>\
                        <autotranslate>'+ cfg.autoTranslate +'</autotranslate>\
                        <sourcelang>'+    project.sourceLang +'</sourcelang>\
                        <targetlang>'+    project.targetLang + '</targetlang>\
                    </options>');
                        ...
                        function process(index){
                            ...
                            while (pos != -1) {
                                ...
                                if (pos == -1) { // last   
                                    ...
                                    var place = $('#dlgSearch #search-results [paragraph="'+parID+'"]:last');
                                    ...
                                    if (place.length > 0) {
                                        ...
                                        div.appendTo( $('#dlgSearch #search-results ') );
                                    }
                                }
                            }       
