                ...
                buttons: [{
                    ...
                    click: function(){     
                        ...
                        function process(index){
                            ...
                            if (cSearchReg) {
                                // strict
                                blk = blk.replace( new RegExp(iSearchVal, 'g'),  '<span class="hightlight">'+iSearchVal+'</span>' );
                                
                            } else {
                                blk = blk
                                        .replace( new RegExp(iSearchVal.toUpperCase(), 'g'),  '<span class="hightlight">'+( iSearchVal.toUpperCase() )+'</span>' )
                                        .replace( new RegExp(iSearchVal.toLowerCase(), 'g'),  '<span class="hightlight">'+( iSearchVal.toLowerCase() )+'</span>' );
                            }
                            ...
                            $('<div/>')
                                ...
                                .appendTo( $('#dlgSearch #search-results') );
                        }
