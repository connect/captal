...
$(document).ready(function(){
    ...
    lang.eng = {
        ...
        block_specialchar   : 'Shon hidden symbols',
                ...
                '<div class="blk_wrapper">\
                    <div class="blk_header">\
                        ...
                        <div class="field logicGLOBAL" title="GLOBAL для всего проекта">\
                            ...
                            <input id="logicGLOBAL" type="checkbox" '+ (o.logicGLOBAL ? 'checked' : '')+' onclick="gui.logicFieldUpdate(this)">\
                        </div>\
...
//$('#data-source').html(res);return;
    ...
    gui.loadLang = function(){
        ...
        for (var line in lang.current){
            ...
            $('[title="{L_'+ (line.toUpperCase()) +'}"]').attr('title', localeString );
        }
        
        // toc & nav
        $('#table-of-contents a[href="#toc-header"]').html( lang.current.project );
        $('#navigator         a[href="#nav-header"]').html( lang.current.navigator );
        
        $('#dlgLoading').html( $('#dlgLoading').html().replace(/{L_LOADING}/ig, lang.current.loading) );
        
        //
        $('#dlgOptions #general .header').html( lang.current.common );
    };
