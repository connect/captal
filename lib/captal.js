...
//$('#data-source').html(res);return;
    ...
    project.loadTXT = function(mode){ debug('project.loadTXT('+mode+')');
        
        var xml         = document.createElement('xml');
        var parMarkers  = $('#dlgImportTXT input[type="radio"]:checked');
        var actMarkers  = $('#dlgImportTXT input[type="checkbox"]:checked');
