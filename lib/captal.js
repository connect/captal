...
$(document).ready(function(){
    ...
    project.exportDOCX = function(){                                                                                                                                      
        ...
        var lang    = $('#dlgExport #lang').val() || 'rus';
            ...
            $('#toc').jstree({
                ...
                */
                ...
                var loadArticles = function() { 
                    ...
                    for (var i in arr) {
                        var j = 0;
                        var jmax = $('#data-source article '+arr[i]+':not([lang])').length;
...
//debug(f.type); return;
    ...
    repo.game.list = function( callback ){
        ...
        $.get('lib/repo_gamelist.json', function( res ){
            var tgame, state;
            ...
            if (res.result == 'ok') {
                ...
                for (var i in res.data.page) {
                    ...
                    $('#dlgRepo #list').append( '<div class="gameRow">'+
                        '<span class="cover"><img src="'+ tgame.cover +'"></span>'+
                        '<span class="gameTitle">'+ tgame.fullname +'</span>'+
                        '<span class="gameStatus">'+ state +'</span>'+                        
                    '</div>');
    ...
    // Development dummies
    $.get('lib/repo_statuses.json',function(res){
        repo.statuses = res;
    });    
