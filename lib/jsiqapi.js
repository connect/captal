	...
	*/
	...
	this.triggerEvent('jsiq_init_start', { self: this }, function(params){
		...
		*/
		...
		self.macros = {"GOTO\\[\\[([0-9]+),\"([0-9a-z A-Z,.�-�;\\(\\)!�-�\"=/\\(\\);']+)\"\\]\\]":gotoarticle_replacer, "GOTO\\[\\[\"([0-9a-z A-Z,.�-�;\\(\\)!�-�\"=/\\(\\);\?><\:']+)\",\"([0-9a-z A-Z,.�-�!�-�\"'=\\(\\)/]+)\"\\]\\]":gotoscript_replacer};
		*/
		if (!isValid(book))	{
			//self.msg('jsIQ: �� ������ ������ ��� �������� �����', 1);
...
jsIQ.parser = {
	...
	wrapScript: function(scriptname, script_text, article)   //, args
	{
		...
		{
			/*
			jsiq_msg('������ ���������� �������: ' + e.message + ', ����� �������: <pre style="border:1px dashed red">' + $.trim(script_text) + '</pre>');
			if (jsIQ.crashreport)
			{
				jsIQ.crashreport('������ ���������� �������: ' + e.message + ', ����� �������: <pre style="border:1px dashed red">' + $.trim(script_text) + '</pre>');
			}
			else
				alert('������ ���������� �����������, ��. ���');*/
